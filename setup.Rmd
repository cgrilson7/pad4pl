...
When R starts up, you'll be greeted with a simple interface and some messages about the version of R you're using. Below those, you'll see a purple carat '**>**' and a cursor awaiting your input. This is where you will type, or copy-and-paste the R code I've provided in this document.

## Installing packages needed to run the app

Before you can run the app, you need to install a few dependencies, called 'packages'. You will only have to do this once. Simply cut and paste the following code into the R Console and hit 'Enter'.
...
Moving forward, this is the only line of code you need to run in order to start up the app. It should open in whichever is your default browser. I find it runs best in Chrome, but you shouldn't have any issues as long as **Javascript is enabled**.
